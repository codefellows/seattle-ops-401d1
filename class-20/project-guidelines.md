...
Your team is performing a security assessment of a system, encompassing all computer security threats to the system and proposing solutions for mitigating threats to attached data resources on the system. 
...
- Threat modelled into a cyber kill chain for analysis 
- Threat modelled into a data flow diagram (DFD)
- Example tabletop scenario including likely human behaviors of involved parties
- Risk analysis
- Technical demonstration of a SIEM monitoring system detecting the threat
- Technical demonstration of a security solution protecting data against the threat
- Technical demonstration of a cloud or network security solution defending against the threat
...
- PD01: Company Overview
- PD02: Security Assesment Report (SAR) as Adobe PDF document
