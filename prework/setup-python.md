...
Follow [this tutorial](https://code.visualstudio.com/docs/python/python-tutorial){:target="_blank"} to setup Visual Studio (VS) Code with Python plugins on your Ubuntu Linux 20.04 Focal Fossa VM.
